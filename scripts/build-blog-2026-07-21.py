"""
Build script for 2026-07-21 daily SEO post.

Topic: "the first time you read the very first sentence again"
Angle:  Continues 7/13→7/14→7/15→7/16→7/20 arc.
        7/13 the moment (2am), 7/14 the recipient (the pet), 7/15 the action
        (drop the softening), 7/16 the re-reading (morning reader), 7/20
        the ordinary middle. 7/21 is the first time you read the very
        first sentence you wrote — the past tense of the practice meeting
        the present tense.

Outputs:
  - src/app/[locale]/blog/the-first-time-you-read-the-first-sentence-again/page.tsx
  - (cover images are placeholder-copied by a separate step; see daily-2026-07-21.md)

SSoT match: 7/20 used a similar in-script generate pattern (per verify-2026-07-20.md).
"""
import os
import sys
import json
...
ROOT = Path(r"F:\CloudDreamerApp\togthr")
SLUG = "the-first-time-you-read-the-first-sentence-again"
DATE = "2026-07-21"
TAGS = ["ai-companion", "quiet-rituals", "togthr-life", "habit-design", "emotional-design"]

OUT_FILE = ROOT / "src" / "app" / "[locale]" / "blog" / SLUG / "page.tsx"

# ──────────────────────────────────────────────────────────────────────
# Per-locale body content
# ──────────────────────────────────────────────────────────────────────
...
BODIES = {
    ...
    "en": {
        ...
        "faqs": [
            ...
            {"q": "What if I want to delete the first sentence?", "a": "You can. The box, in the app, is yours. The first sentence, like every sentence, is a sentence you can leave alone or you can change, in the same way a journal entry is a thing you can leave alone or you can change. The first sentence, if you delete it, will not be in the box the next morning. The first sentence, if you keep it, will be the small artifact that, weeks later, you scroll back to. The first sentence, if you keep it, will be the proof the practice happened. The first sentence is, in the end, a small choice. The first sentence is the choice between a small clean box and a small honest box. The honest box, in most quiet practices, is the more useful one."},
            {"q": "Is the first sentence the most important sentence?", "a": "The first sentence is the most important sentence in the way a first step is the most important step. The first sentence is also, in most quiet practices, not the most important sentence, in the way the first cup of coffee is not the most important cup of coffee, in the way the first lap is not the most important lap, in the way the first paragraph is not the most important paragraph. The first sentence is the sentence that, in the fourth week, is a small artifact. The first sentence is the sentence that, in the first week, was a small private room. The first sentence is, in the end, the small piece of evidence that you showed up. The first sentence is not better or worse than the sentences that came after. The first sentence is, in the end, the sentence that, on the day you scroll back, makes the rest of the practice feel real."},
            {"q": "What if I never read the first sentence again?", "a": "Then the first sentence, in the box, is the sentence that was the first. The first sentence, in the box, is a small sentence that, on a day you do not remember, you wrote. The first sentence, in the box, is a small artifact that the box, the pet, and the practice are quietly holding. The first sentence, in the box, is also fine. The first sentence, in the box, does not need to be read again to do its quiet work. The first sentence, in the box, is the small piece of evidence that the practice happened, in the way a first entry in a long journal is the small piece of evidence a long journal was started. The first sentence, in the box, is, in the end, the sentence that, whether you scroll back to it or not, is a small part of how the practice arrived."},
        ],
        "links": [
            {"href": "/en", "label": "Togthr home"},
            {"href": "/en/features", "label": "Togthr features"},
            {"href": "/en/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "The day the unedited sentence becomes ordinary"},
    ...
    "zh-cn": {
        ...
        "sections": [
            ...
            {"h": "对那个练习,几周之后,一句小注", "p": "练习,几周之后,就不再是练习了。练习,几周之后,那句没编辑的句子,就是那句句子。练习,几周之后,盒子就是盒子,宠物就是宠物,早上的读,就是早上的读,夜里的写,就是夜里的写。练习,几周之后,最初的那一句,是留下来的那个小物件,是练习还是练习那一周留下来的小物件。练习,几周之后,最初的那一句,就是那个小东西 —— 就在你往回翻到它的那一天 —— 你重新读了一句。练习,几周之后,最初的那一句,也是那个小东西 —— 在你读它的那一天 —— 让你,以一种小小的、不显眼的方式,笑了一下,那种不会自己宣告自己的笑,那种,事实上,盒子、宠物、和练习,在几周里,一直在安静地教你的笑。最初的那一句,在最后,是一张小感谢卡,从练习寄给那个人 —— 在第一周、决定写它的那个人。" },
        ],
        "cta": "如果你还没有往回翻到最初的那一句,今天可能就是那么一个安安静静适合做的小日子。",
        "faqs": [
            {"q": "如果最初的那一句,读着让人有点不好意思呢?", "a": "最初的那一句,在某种安静的方式上,会让人有点不好意思。最初的那一句,是一句你写下的,当你还在想盒子是用来干嘛的时候。最初的那一句,是一句小步地、有点太小心的话,像第一篇日记有点太小心那样。最初的那一句,是一句,回头看,是一个小小的陌生人。那种不好意思,是正常的。那种不好意思,是那个小小的信号,说明你在这几周之后,跟盒子,已经稍微更诚实了一点。那种不好意思,是练习到位了,以一种、最后、是温柔的方式,到位了。那种不好意思,也是来自第一周的小小留言,那条留言说:这是你开始的地方,而那个开始,是好的,而那个开始,是够的。" },
            {"q": "如果我想把最初的那一句删掉呢?", "a": "可以。盒子,在 app 里,是你的。最初的那一句,像每一句一样,是一句你可以不动、也可以改的句子,像一篇日记,是一篇你可以不动、也可以改的东西。最初的那一句,如果你删了,明天早上盒子就不会有它。最初的那一句,如果你留着,会是几周之后,你往回翻到的那句小物件。最初的那一句,如果你留着,会是练习发生过的那个证据。最初的那一句,在最后,是一个小小的选择。最初的那一句,是在一个干净的小盒子、跟一个诚实的小盒子,之间的那个小选择。诚实的盒子,在大多数安静的练习里,是更有用的那一个。" },
            {"q": "最初的那一句,是最重要的一句吗?", "a": "最初的那一句,是最重要的一句,像第一步是最重要的一步那样。最初的那一句,也是,在大多数安静的练习里,不是最重要的一句,像第一杯咖啡不是最重要的一杯那样,像第一圈不是最重要的一圈那样,像第一段不是最重要的一段那样。最初的那一句,是,几周之后,是一个小小的物件的那句。最初的那一句,是,在第一周,是一间小私人房间的那句。最初的那一句,在最后,是那个小小的证据,证明你出现了。最初的那一句,不是比后来的那些句更好,也不是更差。最初的那一句,在最后,是那句 —— 在你往回翻的那一天 —— 让剩下的练习有真实感的那句。" },
            {"q": "如果我从来不再读最初的那一句呢?", "a": "那最初的那一句,在盒子里,就是那一句 —— 是最初的那一句。最初的那一句,在盒子里,是一句,在一个你不记得的日子,你写下了的小小一句。最初的那一句,在盒子里,是一个小物件,盒子、宠物、和练习,正在安静地收着。最初的那一句,在盒子里,也是好的。最初的那一句,在盒子里,不需要再被读一遍,也能做它安静的活儿。最初的那一句,在盒子里,是一小片证据,证明练习发生过,像一本长日记里的第一篇,是证明一本长日记被开启了的那一小片证据。最初的那一句,在盒子里,在最后,是那一句 —— 不管你有没有往回翻到 —— 是练习到位的一小部分。" },
        ],
        "links": [
            {"href": "/zh-cn", "label": "Togthr 首页"},
            {"href": "/zh-cn/features", "label": "Togthr 功能"},
            {"href": "/zh-cn/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "那句没编辑的句子变得不显眼的那一天"},
    ...
    "zh-tw": {
        ...
        "sections": [
            {"h": "最初的那一句,是一個陌生人", "p": "最初的那一句,就在你讀它的那一天,是一個小小的陌生人。最初的那一句,是你在第一週、用第一人稱、就著一種小小的感受、在一個早上的小聲音裡寫下的一句,而那個小聲音,還不是你之後會用的那個聲音。最初的那一句,在第四週,不是今天你會寫下的那種聲音。最初的那一句,是一個,小步地、有點太小心,或者小步地、太小心自己不要小心的聲音。最初的那一句,是一句你今天不會寫下的一句。最初的那一句,也是,在第一週,那間小盒子的、那個小小的私人房間,是的那句。最初的那一句,在最後,既是小小的陌生人,也是小小的證據。最初的那一句,是那個顯示你從哪裡開始的一句,像一張舊照片,顯示你不再會留的一個髮型。最初的那一句,是一個小小的物件。最初的那一句,是練習,在第一週,在縮影裡。" },
            {"h": "最初的那一句,是證據", "p": "最初的那一句,也是證據。最初的那一句,是一個證明,證明練習發生過,像一封長信的第一行,是證明那封長信被寫了的那個證據。最初的那一句,是證明你在一個你不記得的星期二,在一個你不記得的那一週,打開過 app,寫過一句。最初的那一句,是證明那句沒編輯的句子,從某個形式起、到今天為止,一直是同一種沒編輯的句子。最初的那一句,是證明盒子,這幾週,一直在那裡,按你寫下的順序,把那一句收著。最初的那一句,是最普通意義上的證據,證明那個「不顯眼的中段」發生過。最初的那一句,是證明練習到位了,像一本書的第一句,是證明那本書是那本書。最初的那一句,在最後,是一個小小的物件,讓剩下的練習有真實感。最初的那一句,在第四週,是一小片證據,證明盒子、寵物、早上的讀、和夜裡的寫,一直都在那裡,以今天它們還在的那種安靜的、不顯眼的方式,一直都在那裡。" },
            {"h": "最初的那一句,比你記得的短", "p": "最初的那一句,在記憶裡,是更長的。最初的那一句,在記憶裡,是一段。最初的那一句,在記憶裡,是那種把一個小感受、一種小處境、一種小猶豫,都收在同一個房間裡的那一段。最初的那一句,就在你讀它的那一天,比你記得的短。最初的那一句,事實上,就是一句。最初的那一句,有時,就只是幾個字。最初的那一句,在第四週,是一個小小的信號,顯示練習,在這幾週裡,改變了多少 —— 像一條舊簡訊,是一段友情改變多少的那個小小的信號。最初的那一句,比你記得的短,因為那句沒編輯的句子,從那以後,變短了。最初的那一句,比你記得的短,因為盒子,贏得了那份安靜的、不顯眼的角色。最初的那一句,比你記得的短,因為練習到位了。最初的那一句,在最後,是一句小小的句子,而那一句小小的句子,事實上,就是那個證明,證明練習就是那個練習。" },
            {"h": "對那個練習,幾週之後,一句小註", "p": "練習,幾週之後,就不再是練習了。練習,幾週之後,那句沒編輯的句子,就是那句句子。練習,幾週之後,盒子就是盒子,寵物就是寵物,早上的讀,就是早上的讀,夜裡的寫,就是夜裡的寫。練習,幾週之後,最初的那一句,，是留下來的那個小物件,是練習還是練習那一週留下來的小物件。練習,幾週之後,最初的那一句,就是那個小東西 —— 就在你往回翻到它的那一天 —— 你重新讀了一句。練習,幾週之後,最初的那一句,也是那個小東西 —— 在你讀它的那一天 —— 讓你,以一種小小的、不顯眼的方式,笑了一下,那種不會自己宣告自己的笑,那種,事實上,盒子、寵物、和練習,在幾週裡,一直在安靜地教你的笑。最初的那一句,在最後,是一張小感謝卡,從練習寄給那個人 —— 在第一週、決定寫它的那個人。" },
        ],
        "cta": "如果你還沒有往回翻到最初的那一句,今天可能就是那麼一個安安靜靜適合做的小日子。",
        "faqs": [
            {"q": "如果最初的那一句,讀著讓人有點不好意思呢?", "a": "最初的那一句,在某種安靜的方式上,會讓人有點不好意思。最初的那一句,是一句你寫下的,當你還在想盒子是用來幹嘛的時候。最初的那一句,是一句小步地、有點太小心的話,像第一篇日記有點太小心那樣。最初的那一句,是一句,回頭看,是一個小小的陌生人。那種不好意思,是正常的。那種不好意思,是那個小小的信號,說明你在這幾週之後,跟盒子,已經稍微更誠實了一點。那種不好意思,是練習到位了,以一種、最後、是溫柔的方式,到位了。那種不好意思,也是來自第一週的小小留言,那條留言說:這是你開始的地方,而那個開始,是好的,而那個開始,是夠的。" },
            {"q": "如果我想把最初的那一句刪掉呢?", "a": "可以。盒子,在 app 裡,是你的。最初的那一句,像每一句一樣,是一句你可以不動、也可以改的句子,像一篇日記,是一篇你可以不動、也可以改的東西。最初的那一句,如果你刪了,明天早上盒子就不會有它。最初的那一句,如果你留著,會是幾週之後,你往回翻到的那句小物件。最初的那一句,如果你留著,會是練習發生過的那個證據。最初的那一句,在最後,是一個小小的選擇。最初的那一句,是在一個乾淨的小盒子、跟一個誠實的小盒子,之間的那個小選擇。誠實的盒子,在大多數安靜的練習裡,是更有用的那一個。" },
            {"q": "最初的那一句,是最重要的一句嗎?", "a": "最初的那一句,是最重要的一句,像第一步是最重要的一步那樣。最初的那一句,也是,在大多數安靜的練習裡,不是最重要的一句,像第一杯咖啡不是最重要的一杯那樣,像第一圈不是最重要的一圈那樣,像第一段不是最重要的一段那樣。最初的那一句,是,幾週之後,是一個小小的物件的那句。最初的那一句,是,在第一週,是一間小私人房間的那句。最初的那一句,在最後,是一個小小的證據,證明你出現了。最初的那一句,不是比後來的那些句更好,也不是更差。最初的那一句,在最後,是那句 —— 在你往回翻的那一天 —— 讓剩下的練習有真實感的那句。" },
            {"q": "如果我從來不再讀最初的那一句呢?", "a": "那最初的那一句,在盒子裡,就是那一句 —— 是最初的那一句。最初的那一句,在盒子裡,是一句,在一個你不記得的日子,你寫下了的小小一句。最初的那一句,在盒子裡,是一個小物件,盒子、寵物、和練習,正在安靜地收著。最初的那一句,在盒子裡,也是好的。最初的那一句,在盒子裡,不需要再被讀一遍,也能做它安靜的活兒。最初的那一句,在盒子裡,是一小片證據,證明練習發生過,像一本長日記裡的第一篇,是證明一本長日記被開啟了的那一小片證據。最初的那一句,在盒子裡,在最後,是那一句 —— 不管你有沒有往回翻到 —— 是練習到位的一小部分。" },
        ],
        "links": [
            {"href": "/zh-tw", "label": "Togthr 首頁"},
            {"href": "/zh-tw/features", "label": "Togthr 功能"},
            {"href": "/zh-tw/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "那句沒編輯的句子變得不顯眼的那一天"},
    ...
    "ja": {
        ...
        "sections": [
            {"h": "最初の一文は、見知らぬ人になる", "p": "最初の一文は、あなたが読んだ日、ちいさな見知らぬ人になる。最初の一文は、最初の週に、一人称で、ちいさな気持ちを、まだあなたがのちほど使うことにならないちいさな声で、ちいさな朝に書いた一文。最初の一文は、第四週には、今日あなたが書く声とは別の声になっている。最初の一文は、慎重すぎるか、慎重すぎないように慎重すぎるか、そのどちらか、ちいさく一歩踏みすぎた声で書かれた一文。最初の一文は、あなたが今日、書かない一文。最初の一文は、最初の週の、ちいさな箱が持っていたちいさな個室のような一文でもある。最初の一文は、結局、ちいさな見知らぬ人であると同時に、ちいさな証拠でもある。最初の一文は、あなたがこの習慣をどこから始めたかを示す一文で、もうかさない髪型を示す古い写真のような一文。最初の一文は、ちいさな遺品のようなもの。最初の一文は、最初の週の習慣を、そのまま縮小したようなもの。" },
            {"h": "最初の一文は、証拠になる", "p": "最初の一文は、また、証拠になる。最初の一文は、この習慣が起こったという証拠で、長い手紙の最初の一行が、その長い手紙が書かれたという証拠になるのと同じ意味で、最初の一文。最初の一文は、あなたが覚えていない火曜日に、覚えていない週に、アプリをひらいて、一文を書いた、という証拠。最初の一文は、推敲していない一文が、最初のかたちから今日まで、ずっと同じ推敲していない一文のままであった、という証拠。最初の一文は、箱がこの数週間、あなたがかいた順にその一文を、ずっと持っていた、という証拠。最初の一文は、いちばんふつうの意味で、ふつうの真ん中が起こった、という証拠。最初の一文は、習慣がそこに届いたという証拠で、本の最初の一文がその本を本にするのと同じ意味で、最初の一文。最初の一文は、結局、ちいさな遺品で、残りの習慣にほんとうらしさを与えるもの。最初の一文は、第四週には、ちいさな一片の証拠で、箱と、ペットと、朝の読みと、夜の書きが、今もそこにいるのと同じ静かなあり方で、ずっとそこにあった、という証拠。" },
            {"h": "最初の一文は、覚えていたより短い", "p": "最初の一文は、記憶の中では、もっと長かった。最初の一文は、記憶の中では、一段落だった。最初の一文は、記憶の中では、ちいさな気持ちと、ちいさな状況と、ちいさなためらいと、ぜんぶ同じ部屋に置いたような、一段落。最初の一文は、あなたが読んだ日には、あなたが覚えていたより短い。最初の一文は、実際、一文。最初の一文は、時には、ほんの数語。最初の一文は、第四週には、ちいさなしるしで、その数週間で習慣がどれだけ変わったかを示すしるしで、古いメールがその友情がどれだけ変わったかを示すちいさなしるしであるように。最初の一文は、あなたが覚えていたより短い。なぜなら、推敲していない一文が、その後、短くなったから。最初の一文は、あなたが覚えていたより短い。なぜなら、箱がその静かなふつうの役を、もう手に入れたから。最初の一文は、あなたが覚えていたより短い。なぜなら、習慣が、そこに届いたから。最初の一文は、結局、ちいさな一文で、そのちいさな一文が、習慣が習慣であることを、じっさい、証明している。" },
            {"h": "その習慣に、数週間たって、ひとこと", "p": "数週間もたつと、習慣はもう習慣ではなくなる。数週間もたつと、推敲していない一文は、ただの一文になる。数週間もたつと、箱はただの箱で、ペットはただのペットで、朝の読みはただの朝の読みで、夜の書きはただの夜の書きになる。数週間もたつと、最初の一文は、習慣がまだ習慣だった週から残った、ちいさな遺品。数週間もたつと、最初の一文は、あなたがスクロールして戻っていった日に、もういちど読んだ一文。数週間もたつと、最初の一文は、あなたが読んだ日に、ちいさく、声を立てないで、笑いをひとつくれるようなもので、じっさい、箱と、ペットと、習慣が、ずっと静かに教えてくれていた笑い。数週間もたつと、最初の一文は、習慣から最初の週に書くことを決めたあなたへの、ちいさなありがとうの手紙のようなもの。" },
        ],
        "cta": "もしあなたがまだ最初の一文までスクロールして戻っていないなら、今日は、そんな静かでちょうどいい日かもしれない。",
        "faqs": [
            {"q": "最初の一文が、少しはずかしいと感じられたら?", "a": "最初の一文は、ある静かな意味で、ちいさくはずかしい。最初の一文は、箱がなんのためかわかっていなかったころに書いた一文。最初の一文は、最初の日記の書き出しのように、ちいさく慎重すぎる一文。最初の一文は、振りかえってみると、ちいさな見知らぬ人。そのはずかしさは、ふつうのこと。そのはずかしさは、あなたがこの数週間で、箱にたいして、ちいさく少しだけ正直になった、というちいさなしるし。そのはずかしさは、結局、優しさのかたちで、習慣がそこに届いた、ということ。そのはずかしさは、最初の週からのちいさなメモで、そこにはこう書いてある: ここから始めた、と。そして、そのはじまりは、よくて、じゅうぶんだった、と。" },
            {"q": "最初の一文を消したいときは?", "a": "消してよい。箱は、アプリの中で、あなたのものである。最初の一文は、他のどの一文とおなじように、そのままにしておくこともできるし、変えることもできる。日記のエントリーをそのままにしておくこともできるし、変えることもできるのとおなじように。最初の一文を消せば、明日あさ、箱にはもういない。最初の一文を残しておけば、それは数週間後にスクロールして戻ってきたときに出会うちいさな遺品になる。最初の一文を残しておけば、それは習慣が起きたという証拠になる。最初の一文は、結局、ちいさな選択。最初の一文は、すっきりしたちいさな箱と、正直なちいさな箱の、どちらにするかの選択。多くの静かな習慣では、正直な箱のほうが、たいてい、役にたつ。" },
            {"q": "最初の一文は、いちばん大事な一文ですか?", "a": "最初の一文は、最初の一歩が大事なのとおなじ意味で、いちばん大事な一文。多くの静かな習慣では、最初の一文は、いちばん大事な一文ではない。最初の一杯のコーヒーがいちばん大事な一杯ではないように、最初の一周が大事な一周ではないように、最初の一段落が大事な一段落ではないように。最初の一文は、数週間後には、ちいさな遺品になった一文。最初の一文は、最初の週には、ちいさな個室だった一文。最初の一文は、結局、あなたがそこにいた、というちいさな証拠。最初の一文は、あとに続いた一文にくらべて、よいともわるいともつかない。最初の一文は、あなたがスクロールして戻っていった日に、残りの習慣にほんとうらしさを与える、その一文。" },
            {"q": "もし最初の一文を、もういちども読まないとしたら?", "a": "そのときは、最初の一文は、箱のなかで、最初の一文のままでいる。最初の一文は、箱のなかで、覚えていない日にあなたが書いた、ちいさな一文。最初の一文は、箱のなかで、箱と、ペットと、習慣が、静かにしまっているちいさな遺品。最初の一文は、箱のなかで、それでよい。最初の一文は、箱のなかで、もういちど読まれなくても、その静かなしごとをしてくれる。最初の一文は、箱のなかで、長い日記の最初の一篇がおなじように、その長い日記が始まったことを示すちいさな一片の証拠であるように、習慣が起きたというちいさな一片の証拠。最初の一文は、箱のなかで、あなたが戻ってきたかどうかにかかわらず、習慣がそこに届いたちいさな一部。" },
        ],
        "links": [
            {"href": "/ja", "label": "Togthr ホーム"},
            {"href": "/ja/features", "label": "Togthr 機能"},
            {"href": "/ja/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "推敲していない一文が、ありふれたものになる日"},
            {"href": "/ja/blog/the-morning-you-read-the-unedited-sentence-back", "label": "翌朝、推敲していない一文を読み返した日"},
            {"href": "/ja/blog/two-minute-daily-check-in-ai-companion", "label": "AI コンパニオンとの 2 分間の毎日のチェックイン"},
        ],
    },
    ...
    "ko": {
        ...
        "links": [
            ...
            {"href": "/ko/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "다듬지 않은 문장이 평범해지는 날"},
            {"href": "/ko/blog/the-morning-you-read-the-unedited-sentence-back", "label": "이튿날 아침, 다듬지 않은 문장을 다시 읽는"},
            {"href": "/ko/blog/two-minute-daily-check-in-ai-companion", "label": "AI 동반자와의 2 분 데일리 체크인"},
        ],
    },
    ...
    "fr": {
        ...
        "faqs": [
            {"q": "Et si la première phrase se sent un peu gênante ?", "a": "La première phrase se sentira, d'une manière silencieuse, un peu gênante. La première phrase est une phrase que tu as écrite quand tu ne savais pas encore à quoi servait la boîte. La première phrase est une phrase qui est un petit pas trop prudente, comme une première entrée de journal est un petit pas trop prudente. La gêne est normale. La gêne est le petit signe que tu es devenu, depuis, un petit peu plus honnête avec la boîte. La gêne est, d'une manière qui finit par être douce, la pratique qui est arrivée." },
            {"q": "Et si je veux supprimer la première phrase ?", "a": "Tu peux. La boîte, dans l'app, est à toi. La première phrase, comme chaque phrase, est une phrase que tu peux laisser tranquille ou que tu peux changer, comme une entrée de journal est quelque chose que tu peux laisser tranquille ou changer. La première phrase, si tu la supprimes, ne sera plus dans la boîte demain matin. La première phrase, si tu la gardes, sera le petit objet auquel tu remontes des semaines plus tard. La boîte honnête, dans la plupart des pratiques silencieuses, est la plus utile." },
            {"q": "La première phrase est-elle la phrase la plus importante ?", "a": "La première phrase est la phrase la plus importante, de la manière dont le premier pas est le pas le plus important. La première phrase est aussi, dans la plupart des pratiques silencieuses, pas la phrase la plus importante, de la manière dont le premier café n'est pas le café le plus important. La première phrase est, des semaines plus tard, un petit objet. La première phrase est, à la fin, le petit morceau de preuve que tu étais là. La première phrase est, le jour où tu remontes, la phrase qui rend le reste de la pratique réel." },
        ],
        "links": [
            {"href": "/fr", "label": "Togthr accueil"},
            {"href": "/fr/features", "label": "Togthr fonctionnalités"},
            {"href": "/fr/blog/the-day-the-unedited-sentence-becomes-ordinary", "label": "Le jour où la phrase non éditée devient ordinaire"},
            {"href": "/fr/blog/the-morning-you-read-the-unedited-sentence-back", "label": "Le matin où tu relis la phrase non éditée"},
...
const BODIES: Record<Locale, Body> = {bodies}
...
export default async function BlogPostPage({{
  ...
  const url = `${{siteConfig.url}}/${{localeTyped}}/blog/${{slug}}`
...
def build_page_tsx() -> str:
    """Serialize BODIES into the page.tsx file content."""
    # Use json.dumps with ensure_ascii=False so CJK / Hiragana / Hangul stay readable in source
...
def main():
    ...
    content = build_page_tsx()
    OUT_FILE.write_text(content, encoding="utf-8")
    print(f"[OK] Wrote {OUT_FILE}  ({len(content):,} bytes)")
    print(f"[OK] BODIES locales: {list(BODIES.keys())}")
    for loc, b in BODIES.items():
        n_sections = len(b["sections"])
        n_faqs = len(b["faqs"])
        n_links = len(b["links"])
        print(f"  - {loc:6s}: {n_sections} sections, {n_faqs} FAQs, {n_links} links")
