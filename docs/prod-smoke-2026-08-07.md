...
- Run at: 2026-08-07 11:11:49 UTC
...
| 8 | F1/F2 pet page: TraceStream + SignalButtons rendered | PASS (2/2) |
| 9 | llms.txt: F1/F2 product facts present | PASS (3/3) |

**Overall**: 9/9 checks PASS (39/43 sub-assertions)
