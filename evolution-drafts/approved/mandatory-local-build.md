# Evolution Proposal: 修复 AGENTS.md 13.1 中"本地 build 可跳过"的危险惯例，强化为必须本地跑 build 且失败必须排查

- Proposal-ID: evo-2026-08-01-mandatory-local-build
- Status: approved
- Signature: mandatory-local-build
- Created-At: 2026-08-01 01:16
- Last-Seen-At: 2026-08-01 01:16
- Target-File: AGENTS.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- 修复 AGENTS.md 13.1 中"本地 build 可跳过"的危险惯例，强化为必须本地跑 build 且失败必须排查
...
## User Approval
- Approve: 批准 evo-2026-08-01-mandatory-local-build
- Reject: 拒绝 evo-2026-08-01-mandatory-local-build