// src/app/[locale]/p/virtual-pet-that-grows-up-like-tamagotchi/page.tsx
//
...
const META_TITLE = `A Virtual Pet That Grows Up Like Tamagotchi`
const META_DESC = `A virtual pet that grows up like Tamagotchi, baby to legend, in 5 stages. Lives in your browser, never punishes, never dies. Free to start.`
