// src/app/[locale]/p/friendship-check-in-app/page.tsx
//
...
const SLUG = `friendship-check-in-app`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Friendship Check-in App 鈥?Togthr`
const META_DESC = `A friendship check-in app built around a small shared pet, not a feed. One sentence a day each, the pet grows. No ads, no streaks.`
