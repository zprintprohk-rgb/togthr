// src/app/[locale]/p/tamagotchi-30th-anniversary-app/page.tsx
//
...
const SLUG = `tamagotchi-30th-anniversary-app`
const HERO_IMG = `/pets/anim-idle-1.png`
const META_TITLE = `A Tamagotchi 30th-Anniversary Companion 鈥?Togthr`
const META_DESC = `A Tamagotchi 30th-anniversary companion: the care-and-grow loop, but in your browser, with 5 growth stages and a 1-in-72 golden edition.`
