// src/app/[locale]/p/couple-desktop-pet-app/page.tsx
//
...
const SLUG = `couple-desktop-pet-app`
const HERO_IMG = `/pets/scene-progress.png`
const META_TITLE = `Couple Desktop Pet App 鈥?Togthr`
const META_DESC = `Togthr is a small pixel pet that lives in your browser and grows with your relationship. No ads, no streak pressure, no chat. Subscription: $5.49/mo.`
