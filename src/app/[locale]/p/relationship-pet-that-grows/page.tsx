// src/app/[locale]/p/relationship-pet-that-grows/page.tsx
//
...
const SLUG = `relationship-pet-that-grows`
const HERO_IMG = `/pets/scene-progress.png`
const META_TITLE = `A Relationship Pet That Grows With You 鈥?Togthr`
const META_DESC = `A relationship pet that grows through 5 stages, baby to legend, only while both of you keep showing up. The quietest check-in we know.`
