// src/app/[locale]/p/long-distance-relationship-widget/page.tsx
//
...
const SLUG = `long-distance-relationship-widget`
const HERO_IMG = `/pets/scene-progress.png`
const META_TITLE = `Long-Distance Relationship Widget 鈥?Togthr`
const META_DESC = `A long-distance relationship widget that is more than a wallpaper: a shared pixel pet that grows as both of you keep showing up. Free to start.`
