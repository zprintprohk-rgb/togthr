// src/app/[locale]/p/shared-pixel-pet-with-friends/page.tsx
//
...
const SLUG = `shared-pixel-pet-with-friends`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Shared Pixel Pet With Friends 鈥?Togthr`
const META_DESC = `A shared pixel pet with friends: you and a friend write a sentence each day, the pet grows through 5 stages. The simplest ritual we know.`
