// src/app/[locale]/p/time-capsule-app-for-two/page.tsx
//
...
const SLUG = `time-capsule-app-for-two`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Time Capsule App for Two 鈥?Togthr`
const META_DESC = `A time capsule app for two: write a sentence today, lock it, and open it together on a future date. The pet guards the capsule until then.`
