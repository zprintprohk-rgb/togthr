// src/app/[locale]/p/shared-journal-app-for-couples/page.tsx
//
...
const SLUG = `shared-journal-app-for-couples`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Shared Journal App for Couples 鈥?Togthr`
const META_DESC = `A shared journal app for couples built around a pixel pet that grows as you write. No ads, no feed, no streaks. Free to start in your browser.`
