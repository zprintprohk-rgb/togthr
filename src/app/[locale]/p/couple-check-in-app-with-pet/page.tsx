// src/app/[locale]/p/couple-check-in-app-with-pet/page.tsx
//
...
const SLUG = `couple-check-in-app-with-pet`
const HERO_IMG = `/pets/scene-progress.png`
const META_TITLE = `A Couple Check-in App With a Pet 鈥?Togthr`
const META_DESC = `A couple check-in app with a pet at the centre: one sentence each, then the pet grows. The quiet ritual that keeps curiosity alive.`
