// src/app/[locale]/p/virtual-pet-for-emotional-support/page.tsx
//
...
const SLUG = `virtual-pet-for-emotional-support`
const HERO_IMG = `/pets/character-sheet.png`
const META_TITLE = `A Virtual Pet for Emotional Support 鈥?Togthr`
const META_DESC = `A virtual pet for emotional support that asks nothing of you. Lives in your browser, grows through 5 stages, waits when you are tired.`
