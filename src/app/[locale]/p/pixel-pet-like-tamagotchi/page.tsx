// src/app/[locale]/p/pixel-pet-like-tamagotchi/page.tsx
//
...
const META_TITLE = `A Pixel Pet Like Tamagotchi, but Quieter 鈥?Togthr`
const META_DESC = `A pixel pet like Tamagotchi, but quieter and gentler. Lives in your browser, grows through 5 stages, and never dies if you forget for a weekend.`
