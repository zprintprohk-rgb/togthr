// src/app/[locale]/p/private-journal-for-couples-app/page.tsx
//
...
const SLUG = `private-journal-for-couples-app`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Private Journal for Couples 鈥?Togthr`
const META_DESC = `A private journal for couples that lives in your browser. One sentence a day each, a pet that grows, and no-one else reading.`
