// src/app/[locale]/p/best-app-for-couples-in-long-distance/page.tsx
//
...
const SLUG = `best-app-for-couples-in-long-distance`
const HERO_IMG = `/pets/character-sheet.png`
const META_TITLE = `Best App for Couples in Long Distance`
const META_DESC = `Looking for the best app for couples in long distance? Togthr is a pixel pet that grows as you two keep showing up, with no pressure.`
