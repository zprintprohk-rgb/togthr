// src/app/[locale]/p/a-pixel-pet-that-notices-you/page.tsx
//
...
const SLUG = `a-pixel-pet-that-notices-you`
const HERO_IMG = `/pets/character-sheet.png`
const META_TITLE = `A Pixel Pet That Notices You 鈥?Togthr`
const META_DESC = `A pixel pet that notices you: it grows when you show up, pauses when you rest, and the small creature in the corner remembers the month you just had.`
