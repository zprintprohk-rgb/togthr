// src/app/[locale]/p/couple-bedtime-routine-app/page.tsx
//
...
const SLUG = `couple-bedtime-routine-app`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Couple Bedtime Routine App 鈥?Togthr`
const META_DESC = `A couple bedtime routine app: one quiet sentence before sleep, one pixel pet that grows, one small ritual that keeps the distance from growing.`
