// src/app/[locale]/p/virtual-pet-to-share-with-best-friend/page.tsx
//
...
const SLUG = `virtual-pet-to-share-with-best-friend`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Virtual Pet to Share With Your Best Friend`
const META_DESC = `A virtual pet to share with your best friend, even across time zones. Both of you write a sentence, the pet grows. Free to start.`
