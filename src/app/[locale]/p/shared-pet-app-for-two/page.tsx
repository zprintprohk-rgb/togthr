// src/app/[locale]/p/shared-pet-app-for-two/page.tsx
//
...
const SLUG = `shared-pet-app-for-two`
const HERO_IMG = `/pets/scene-progress.png`
const META_TITLE = `A Shared Pet App for Two 鈥?Togthr`
const META_DESC = `A shared pet app for two people, not a chat app. You each write one sentence; the pet grows. No ads, no streaks. Subscription: $5.49/mo.`
