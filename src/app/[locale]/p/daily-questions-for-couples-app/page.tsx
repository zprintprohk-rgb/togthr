// src/app/[locale]/p/daily-questions-for-couples-app/page.tsx
//
...
const SLUG = `daily-questions-for-couples-app`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `Daily Questions for Couples 鈥?A Gentle App`
const META_DESC = `Daily questions for couples, answered in one sentence each, held by a small pixel pet that grows with every answer. No chat, no feed.`
