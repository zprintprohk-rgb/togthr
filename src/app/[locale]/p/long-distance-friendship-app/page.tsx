// src/app/[locale]/p/long-distance-friendship-app/page.tsx
//
...
const SLUG = `long-distance-friendship-app`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Long-Distance Friendship App 鈥?Togthr`
const META_DESC = `A long-distance friendship app for grown-ups. A shared pixel pet that lives in your browser, grows as you keep in touch, free to start.`
