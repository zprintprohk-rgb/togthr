// src/app/[locale]/p/lonely-desk-companion/page.tsx
//
...
const META_TITLE = `A Lonely Desk Companion That Actually Stays 鈥?Togthr`
const META_DESC = `A lonely desk companion that does not ask for a conversation. A small pixel pet that just sits with you while you work. Free to start in browser.`
