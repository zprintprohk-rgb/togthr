// src/app/[locale]/p/anniversary-countdown-app-couples/page.tsx
//
...
const SLUG = `anniversary-countdown-app-couples`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `An Anniversary Countdown App for Couples`
const META_DESC = `An anniversary countdown app for couples with a pet that grows toward the date alongside you. The countdown is the ritual, the pet is the reward.`
