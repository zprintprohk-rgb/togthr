// src/app/[locale]/p/tamagotchi-for-desktop/page.tsx
//
...
const SLUG = `tamagotchi-for-desktop`
const HERO_IMG = `/pets/anim-idle-1.png`
const META_TITLE = `Tamagotchi for Your Desktop 鈥?Togthr`
const META_DESC = `A Tamagotchi for your desktop, but it never dies and never punishes you. 5 growth stages, lives in your browser, free to start.`
    ...
    <article className="mx-auto max-w-3xl px-4 py-12 text-zinc-100">
      ...
      <section aria-label="Summary" className="mt-6 rounded-xl border border-pink-500/20 bg-pink-500/5 px-5 py-4">
        <p className="text-sm leading-relaxed text-zinc-400">
          Togthr is a 5-stage pixel pet for desktop browsers, designed as a modern Tamagotchi alternative. It grows from baby to legend over months as you check in daily. No ads, no death, $5.49/month or $37.99/year.
        </p>
      </section>
