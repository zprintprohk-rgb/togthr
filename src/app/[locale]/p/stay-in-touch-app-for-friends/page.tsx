// src/app/[locale]/p/stay-in-touch-app-for-friends/page.tsx
//
...
const SLUG = `stay-in-touch-app-for-friends`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Stay-in-Touch App for Friends 鈥?Togthr`
const META_DESC = `A stay-in-touch app for friends who keep meaning to text more. A small pet that nudges no one, just grows as you both show up.`
