// src/app/[locale]/p/desktop-pet-for-work-from-home/page.tsx
//
...
const SLUG = `desktop-pet-for-work-from-home`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Desktop Pet for Working From Home 鈥?Togthr`
const META_DESC = `A desktop pet for working from home. Quiet, present, and grown by your own check-ins. The 8 a.m. to 6 p.m. companion you did not know you needed.`
