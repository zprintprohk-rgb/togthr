// src/app/[locale]/p/couple-mood-tracker-app/page.tsx
//
...
const SLUG = `couple-mood-tracker-app`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Couple Mood Tracker App 鈥?Togthr`
const META_DESC = `A couple mood tracker app with a pixel pet that changes its mood alongside yours. No typing required 鈥?just tap how you feel.`
