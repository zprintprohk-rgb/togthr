...
const META_TITLE = `A Couple Mood Tracker App — Togthr`
const META_DESC = `A couple mood tracker app with a pixel pet that changes its mood alongside yours. No typing required — just tap how you feel.`
