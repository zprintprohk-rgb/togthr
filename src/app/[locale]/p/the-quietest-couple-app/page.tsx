// src/app/[locale]/p/the-quietest-couple-app/page.tsx
//
...
const SLUG = `the-quietest-couple-app`
const HERO_IMG = `/pets/character-sheet.png`
const META_TITLE = `The Quietest Couple App on the Internet`
const META_DESC = `The quietest couple app on the internet: a small pixel pet, one sentence a day, no chat, no feed, no streaks. Try it free in your browser.`
