// src/app/[locale]/p/best-friend-daily-ritual-app/page.tsx
//
...
const SLUG = `best-friend-daily-ritual-app`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Best-Friend Daily Ritual App 鈥?Togthr`
const META_DESC = `A best-friend daily ritual app that is not a social network. A small pet, a shared sentence, no streaks. Try it free, $5.49/mo to keep it.`
