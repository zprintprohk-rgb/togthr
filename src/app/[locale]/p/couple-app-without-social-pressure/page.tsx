// src/app/[locale]/p/couple-app-without-social-pressure/page.tsx
//
...
const SLUG = `couple-app-without-social-pressure`
const HERO_IMG = `/pets/character-sheet.png`
const META_TITLE = `A Couple App Without Social Pressure`
const META_DESC = `A couple app without social pressure: a small pixel pet, one sentence a day, no friends list, no like count, no feed. Just two people and a pet.`
