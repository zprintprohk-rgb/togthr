// src/app/[locale]/p/couple-goals-tracker-app/page.tsx
//
...
const SLUG = `couple-goals-tracker-app`
const HERO_IMG = `/pets/scene-rainy.png`
const META_TITLE = `A Couple Goals Tracker App 鈥?Togthr`
const META_DESC = `A couple goals tracker app where a small pet grows with each shared goal you reach. The pet remembers the wins, including the small ones.`
