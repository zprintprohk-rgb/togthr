// src/app/[locale]/p/desktop-pet-for-besties/page.tsx
//
...
const SLUG = `desktop-pet-for-besties`
const HERO_IMG = `/pets/scene-birthday.png`
const META_TITLE = `A Desktop Pet for Besties 鈥?Togthr`
const META_DESC = `A desktop pet for besties. Lives in your browser, grows with the friendship, and remembers the boring Tuesdays as well as the big news.`
