// src/app/[locale]/p/low-pressure-companion-app/page.tsx
//
...
const META_TITLE = `A Low-Pressure Companion App 鈥?Togthr`
const META_DESC = `A low-pressure companion app for anyone tired of social. A small pet that grows, no friends list, no feed, no notifications unless you want them.`
