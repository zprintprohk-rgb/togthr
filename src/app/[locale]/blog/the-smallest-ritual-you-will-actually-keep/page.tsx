...
const BODIES: Record<Locale, Body> = {
  en: {
    ...
    cta: `Start your five-second ritual today — and meet the pixel pet that never asks you to keep it going, but makes you want to. Try Togthr free at togthr.life. Monthly is $5.49; yearly is $37.99.`,
    faqs: [
